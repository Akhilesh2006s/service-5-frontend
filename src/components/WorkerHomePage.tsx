...
export const WorkerHomePage: React.FC = () => {
  ...
  const handleUpdateTask = async (e: React.FormEvent) => {
    ...
    if (updateData.workProof && !updateData.workProof.includes('drive.google.com')) {
      toast({
        title: "Invalid Link",
          ...
          <Card className="w-full max-w-md">
            ...
            <CardContent>
              <form onSubmit={handleUpdateTask} className="space-y-4">
                ...
                <div>
                  <label className="text-sm font-medium text-gray-700">Work Proof (Google Drive Link)</label>
                  <div className="space-y-2">
                    <Textarea
                      ...
                      rows={2}
                    />
                    {updateData.workProof && updateData.workProof.includes('drive.google.com') && (
                      <div className="flex items-center space-x-2">
                        <a 
                          href={updateData.workProof} 
                          target="_blank" 
                    ...
                    {updateData.workProof && !updateData.workProof.includes('drive.google.com') && (
                      <span className="text-xs text-red-600">⚠️ Please provide a valid Google Drive link</span>
                    )}
                  </div>
                  <p className="text-xs text-gray-500 mt-1">
                    📎 Paste your Google Drive link here (e.g., https://drive.google.com/file/d/...)
                  </p>
                </div>
